...
//Initial score definition
#define ARG_OPENING_SCORE		'o'
...
int libmasa_entry_point(int argc, char** argv, IAligner* aligner, char* aligner_header) {
	...
	//Opening pruning score for BLASTn
	_job->opening_score = -INF;
    ...
    static struct option long_options[] = {
		...
		// Blastn opening score 
		{"opening-score", required_argument,	0, ARG_OPENING_SCORE},
	...
	try {
		while ( 1 ) {
			...
			case ARG_SPECIAL_ROWS_DIR:
				...
				break;
			case ARG_OPENING_SCORE:
				
				_job->setOpeningScore( optarg );
